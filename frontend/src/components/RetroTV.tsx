      ...
      <style>{`
        ...
        .retro-tv-rgb-r {
          ...
          background: repeating-linear-gradient(
            ...
            transparent 0px,
            transparent 2px,
            rgba(255, 0, 0, 0.018) 2px,
            rgba(255, 0, 0, 0.018) 4px
          );
          mix-blend-mode: screen;
          transform: translateX(0.8px);
          animation: rgb-drift 8s ease-in-out infinite;
        }
        ...
        .retro-tv-rgb-b {
          ...
          background: repeating-linear-gradient(
            ...
            transparent 0px,
            transparent 2px,
            rgba(0, 80, 255, 0.018) 2px,
            rgba(0, 80, 255, 0.018) 4px
          );
          mix-blend-mode: screen;
          transform: translateX(-0.8px);
          animation: rgb-drift 8s ease-in-out infinite reverse;
        }
